	...
	<div class="h-full w-full max-w-md mx-auto bg-zinc-500 flex flex-col">
		...
		<div class="h-full w-full p-4">
			{#each messages as message}
				<div
					class="bg-zinc-300 rounded-xl px-4 py-3 my-4"
					class:mine={message.from === username}
					class:yours={message.from !== username}
				>
...
<style style="scss">
  .mine {
    @apply rounded-tr-none ml-[25%];
  }
  .yours {
    @apply rounded-tl-none bg-zinc-400 mr-[25%];
  }
</style>